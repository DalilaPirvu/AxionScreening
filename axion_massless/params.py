...
new_dirdata = lambda nZs,zMin,zMax,lMax,multi: '/gpfs/dpirvu/axiondata/test_axion_nZs'+str(int(nZs)) + '_zmin'+str(zMin) + '_zmax'+str(zMax) + '_ellMax'+str(int(lMax)) + '_rvir' +str(int(multi))

new_test_data = lambda nZs,zMin,zMax,lMax,multi,rscale: new_dirdata(nZs,zMin,zMax,lMax,multi)+'_files_'+('rscale' if rscale else 'r0')+'.npy'

new_cl_data_galtau_path = lambda nZs,zMin,zMax,lMax,name,multi,galcol,dictn: new_dirdata(nZs,zMin,zMax,lMax,multi)+name+'_galtau_Cl_' + galcol + str(dictn) + '.npy'
new_cl_data_galgal_path = lambda nZs,zMin,zMax,lMax,name,multi,galcol,dictn: new_dirdata(nZs,zMin,zMax,lMax,multi)+name+'_galgal_Cl_' + galcol + str(dictn) + '.npy'

new_ILCnoisePS_path = lambda expname,zreio,multi: '/home/dpirvu/axion_new/data/test_axion_'+expname+'_rvir' +str(int(multi))+'_ILC_remainder_zreio'+ str(int(zreio))+'.npy'
new_weights_path    = lambda expname,zreio,multi: '/home/dpirvu/axion_new/data/test_axion_'+expname+'_rvir' +str(int(multi))+'_ILC_weights_zreio'  + str(int(zreio))+'.npy'
